...
fun FinishScreen(quizViewModel: QuizViewModelnew) {
    ...
    when (getQuestionType) {
        ...
        1 -> quizViewModel.isFinished1()
        2 -> quizViewModel.isFinished2()
        3 -> quizViewModel.isFinished3()
        4 -> quizViewModel.isFinished4()
        5 -> quizViewModel.isFinished5()
        6 -> quizViewModel.isFinished6()
        7 -> quizViewModel.isFinished7()
    }
