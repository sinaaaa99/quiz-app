        ...
        return listOf(
            ...
            Questions(
                ...
                "برای زنان باردار سالم که شروع لیبر خود به خودی دارند، سیاست تأخیر در پذیرش در بخش لیبر تا شروع فاز فعال تنها بعد از انجام تحقیقات دقیق توصیه می شود. از سوی دیگر با در نظر گرفتن مسافت زیاد (ساکن در شهرستان) از بیمارستان بهتر است بستری شوند\n" +
                        "تا زمانیکه شواهد بیشتری فراهم شود، زنانی که به تسهیلات زایمان مراجعه میکنند، حتی در اوایل لیبر، بایستی به طرز مناسبی بستری و حمایت شوند، مگر اینکه ترجیح وی منتظر ماندن در منزل تا شروع فاز فعال لیبر باشد\n" +
                        "برای زنانی که در بخش لیبر در مراحل اولیه فاز نهفته بستری میشوند، اگر حال مادر و جنین خوب است بهتر است از مداخلات پزشکی برای تسریع لیبر و زایمان پرهیز شود\n",
                1
            ),
            Questions(
                2,
                ...
                isLast = false,
                isAnswered = false,
                " مدل های مراقبت مستمر ماما(MLCC)مدل هایی از مراقبت هستند که در آن یک مامای شناخته شده و قابل اعتماد (مامای کیسلود) یا گروه کوچکی از ماماهای شناخته شده (مامای تیمی)، یک زن را در دوره ی بارداری، زایمان و پس از زایمان برای سهولت بارداری و زایمان و عملکردهای والدی سالم حمایت می کنند. بایستی اجرای این مدل در محیط های بدون برنامه ی مامایی کارآمد، پس از افزایش ماماهای شاغل (و بهبود کیفیت) در نظر گرفته شود. بنابراین با توجه به عدم وجود شرایط لازم و کافی در سیستم بهداشتی کشور ما، در حال حاضر توصیه نمی شود ",
                2
            ),
            Questions(
                3,
            ...
            Questions(
                ...
                isLast = false,
                isAnswered = false,
                "ارتباط موثر بین مراقب و زن، با استفاده از روش های ساده و پذیرفته شده به لحاظ فرهنگی توصیه می شود. یکی از شروط لازم این است که مراقب بایستی خود را به مادر و همراه وی معرفی نموده و وی را با اسمش خطاب نماید",
                4
            ),
            Questions(
                5,
            ...
            Questions(
                ...
                isLast = false,
                isAnswered = false,
                "استفاده از تعاریف زیر برای فازهای نهفته و فعال در مرحله اول لیبر توصیه میشوند\n" +
            ...
            Questions(
                8,
                "مراقب بایستی زن باردار را از مکانیسمهای موجود برای رسیدگی به شکایات مطلع نماید",
                1,
                answerState = false,
                isLast = false,
                isAnswered = false,
            ...
            Questions(
                ...
                "پلویمتری بالینی روتین هنگام بستری شدن برای زنان باردار سالم در واحد لیبر توصیه نمی شود\n" +
                        ...
                        "شواهد غیرمستقیم حاصل از مطالعات انجام شده در مورد پلویمتری اشعه ایکس نشان میدهد که پلویمتری روتین در زنان باردار سالم هنگام بستری شدن در واحد لیبر ممکن است سزارین را بدون اینکه مزایای مشخصی از نظر پیامدهای زایمانی داشته باشد، افزایش دهد\n",
                2
            ),
            Questions(
                13,
                ...
                isLast = false,
                isAnswered = false,
                "کاردیوتوکوگرافی روتین برای ارزیابی وضعیت جنین در هنگام پذیرش در لیبر در زنان باردار سالمی که با لیبر خودی مراجعه می کنند، توصیه نمی شود. کاردیوتوکوگرافی مداوم، سزارین و سایر مداخلات پزشکی را بدون اینکه هزینه اثربخش باشد و با سهولت و مقبولیت متفاوت، افزایش می دهد",
                3
            ),
            Questions(
                14,
            ...
            Questions(
                16,
                "برای کاهش استفاده از تقویت لیبر (Augmentation) انما انجام گیرد",
                2,
                answerState = false,
                isLast = true,
                isAnswered = false,
